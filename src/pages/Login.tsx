      ...
      <div className="flex-1 px-6 pt-4 flex flex-col items-center">
        <div className="w-full max-w-sm sm:max-w-md">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-slate-400 text-sm">Sign in to access your financial dashboard</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="mt-8 space-y-4">
            ...
            <button onClick={() => navigate('/forgot-password')} className="text-emerald-400 text-sm font-medium self-end">
              Forgot Password?
            </button>
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full h-14 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold shadow-lg shadow-emerald-500/25 active:scale-[0.98] transition-transform disabled:opacity-50 flex items-center justify-center"
            >
              {loading ? (
          ...
          <p className="text-center text-slate-500 text-sm mt-8">
            ...
            <button onClick={() => navigate('/signup')} className="text-emerald-400 font-medium">Sign Up</button>
          </p>
        </div>
      </div>
